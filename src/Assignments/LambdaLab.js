...
// 3. Open Postman, then make a request at http://localhost:3000/<<lambda file name in all lowercase>> with raw JSON in its body: {"provider": "Future Works"}
// The results should print in console.

// 4. Every time you refactor your code, in VS Code Terminal, stop the server by pressing: Control + C. Then restart the server to test your refactored code: sls offline. Then test the request in Postman.

// 5. Remember to stop your server with Control + C when it's not needed.
